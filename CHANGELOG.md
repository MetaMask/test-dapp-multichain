...
- chore: Fix build entrypoints ([#26](https://github.com/MetaMask/test-dapp-multichain/pull/26))
...
[Unreleased]: https://github.com/MetaMask/test-dapp-multichain/compare/v0.3.1...HEAD
